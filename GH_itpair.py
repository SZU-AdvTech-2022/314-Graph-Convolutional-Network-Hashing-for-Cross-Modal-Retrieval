...
class GH(object):
    ...
    def _build_model(self):
        ...
        # check = bit
        # self.Loss_pair_g = self.mse_loss(item_g, check*self.ph['Sim'])     # 改变相似度度量方式
        ...
        # self.Loss_pair_i = self.mse_loss(item_i, check*self.ph['Sim'])     # 改变相似度度量方式
        ...
        # self.Loss_pair_t = self.mse_loss(item_t, check*self.ph['Sim'])      # 改变相似度度量方式
