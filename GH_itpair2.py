...
class GH(object):
    ...
    def _build_model(self):
        ...
        self.Loss_img_text = self.mse_loss(self.Fea_I, self.Fea_T)       # 减少图像和文本间的差距
        self.Loss_I_hsh = self.Loss_pair_i + self.Loss_img_text + self.mse_loss(self.Hsh_I, self.ph['B'])  # J1
        ...
        self.Loss_text_img = self.mse_loss(self.Fea_I, self.Fea_T)  # 减少图像和文本间的差距
        self.Loss_T_hsh = self.Loss_pair_t + self.Loss_text_img + self.mse_loss(self.Hsh_T, self.ph['B'])
